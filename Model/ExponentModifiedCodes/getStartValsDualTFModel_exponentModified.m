function [startPoint,lowerbound,upperbound] = getStartValsDualTFModel_exponentModified(numTFs,modelNum,Delta,MonkeyID)
...
if modelNum==1 % Free parameters sigma, exponent, supression values; Untuned normalization model- Salelkar and Ray 2020
    ...
    startPoint = [sigmaStart LampStart nStart SuppressionVals];
    lowerbound = [0.1 1 1 lowerbound_supression];
    upperbound = [4 15 4 upperbound_supression];
...
elseif modelNum==2
    ...
    if strcmpi(MonkeyID,'M3')
        ...
        upperbound = [4 15 4 40 Inf Inf 1];
    ...
    startPoint = [sigmaStart LampStart nStart cutOffStart alpha1Start alpha2Start scalingFactor];
