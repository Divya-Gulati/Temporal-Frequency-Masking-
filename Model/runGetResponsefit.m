...
for modelNum =1:length(ModelNames)
    ...
    save(fullfile(savedestination,SaveFilname),'observedData','estData','errorResidual','Parameters','expVar','errorVar','exitflag','tfList','dList','cList','TargetFrequency','maskTFList');
end